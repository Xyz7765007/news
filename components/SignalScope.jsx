...
function ExportModal({ show, onClose, csvColumns, tasks, companies, allNews }) {
  ...
  const newsGroup = [
    ...
    { key: "signalType", label: "Signal Type (News/Job)" },
  ...
  const allCols = [...companyGroup, ...csvGroup, ...taskGroup, ...newsGroup, ...insightsGroup];
  ...
  const getTaskInsights = (t) => {
    ...
    if (tn.includes("cmo") || tn.includes("hire") || tn.includes("appointment")) {
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" style={{ maxWidth: 580 }} onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-body" style={{ maxHeight: "60vh", overflowY: "auto" }}>
          <p style={{ fontSize: 13, color: "var(--text-secondary)", marginBottom: 16 }}>Select columns for your CSV export. {tasks.length} task{tasks.length !== 1 ? "s" : ""} will be exported.</p>
        ...
        <div className="modal-footer" style={{ justifyContent: "space-between", alignItems: "center" }}>
          <span style={{ fontSize: 11, color: "var(--text-tertiary)" }}>{selectedCols.length} columns selected</span>
          <div style={{ display: "flex", gap: 8 }}>
            <button className="btn btn-secondary" onClick={onClose}>Cancel</button>
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="task-detail-modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="td-body">
          ...
          {/* Article Excerpt */}
          {task.articleContent && task.articleContent.length > 50 && (
            <div className="td-section">
